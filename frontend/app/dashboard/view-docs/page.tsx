...
export default function DashboardViewDocsPage() {
            ...
            <main className="flex-1 flex flex-col px-10 py-8 pb-12 overflow-y-auto h-screen">
                <header className="mb-10">
                    ...
                    <p className={`mt-2 text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                        Documentation for logged-in users - Dashboard (Authenticated Users Only)
                    </p>
                    <p className={`mt-1 text-xs ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>
                        This is the dashboard version. For public access, visit <Link href="/view-docs" className="underline hover:text-[#2df4c6]">Public View Docs</Link>
                    </p>
                </header>
                    ...
                    <section className="flex flex-col gap-8 items-center">
                        ...
                        <div className="flex flex-wrap gap-8 justify-center w-full">
                            <DocCard
                                ...
                                buttonColor="green"
                                href="/dashboard/view-docs/document"
                                isDarkMode={isDarkMode}
                            />
                            <DocCard
                                title="Tutorials"
                                ...
                                buttonText="Get Start"
                                buttonColor="green"
                                href="/dashboard/view-docs/tutorials"
                                isDarkMode={isDarkMode}
                            />
                            <DocCard
                                ...
                                buttonText="Get Start"
                                buttonColor="green"
                                href="/dashboard/view-docs/learn_about"
                                isDarkMode={isDarkMode}
                            />
                        </div>
                    </section>
