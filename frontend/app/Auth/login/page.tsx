...
export default function LoginPage() {
  // Minimal state so the form still looks interactive, but no backend calls.
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // ไม่มีระบบ auth จริง ให้ถือว่าล็อกอินสำเร็จ แล้วไปหน้า Generate (หน้าแรก)
    router.push("/");
  };
            ...
            <div className="mb-8">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center mt-12">
                  <button
                    type="submit"
                    className="bg-black text-white rounded-full px-12 py-3 text-sm font-semibold transition transform hover:scale-[1.02] hover:shadow-[0_10px_26px_rgba(16,185,129,0.28)]"
                  >
                    Sign In
                  </button>
                </div>
