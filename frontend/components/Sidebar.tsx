        ...
        <>
            ...
            {isTelegramModalOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className={`w-full max-w-md rounded-2xl p-6 shadow-2xl transition-all ${isDarkMode ? "bg-[#1e2330] border border-gray-700" : "bg-white border border-[#E2E8F0]"
                        }`}>
                        <h3 className={`text-xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-[#0F172A]"}`}>
                            Connect Telegram
                        </h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                                <p className={`text-sm mb-3 ${isDarkMode ? "text-gray-300" : "text-[#334155]"}`}>
                            ...
                            <div className="pt-4 border-t border-gray-700/50">
                                <details className="text-xs group">
                                    <summary className={`cursor-pointer list-none flex items-center gap-2 ${isDarkMode ? "text-gray-500 hover:text-gray-300" : "text-[#64748B] hover:text-[#334155]"}`}>
                                    ...
                                    <div className="pt-3 space-y-3">
                                        <input
                                            ...
                                            className={`w-full rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 ${isDarkMode
                                                ? "bg-[#0c111f] text-white focus:ring-[#2df4c6]"
                                                : "bg-[#F8FAFC] text-[#0F172A] border border-[#E2E8F0] focus:ring-[#2563EB]"
                                                }`}
                                        />
                                        <button
                                            onClick={handleSaveTelegram}
                                            className={`w-full py-2 rounded-lg text-xs font-medium border ${isDarkMode ? "border-gray-600 text-gray-300 hover:bg-white/5" : "border-[#E2E8F0] text-[#334155] hover:bg-[#F8FAFC]"}`}
                                        >
                                            Save ID Manually
                                        </button>
                                    </div>
                        ...
                        <div className="flex justify-center mt-6">
                            <button
                                ...
                                className={`text-xs ${isDarkMode ? "text-gray-500 hover:text-white" : "text-[#64748B] hover:text-[#0F172A]"}`}
                            >
                                Close
                            </button>
                        </div>
